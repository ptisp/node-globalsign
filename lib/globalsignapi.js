 ...
 * @param {String} approverurl
 * @param {Function} callback
 */
API.prototype.URLVerificationForIssue = function(orderid, approverurl, callback) {
  var params = {
 ...
 * @param {Function} callback
 */
API.prototype.ChangeApproverEmail = function(orderid, fqdn, email, callback) {
  var params = {
    'Request': {
      'OrderRequestHeader': {
        'AuthToken': this.auth
  ...
  this.client.ChangeApproverEmail(params, function(err, result, raw, soapHeader) {
    if (err) return callback({
      'status': '500',
      'output': {
        'result': 'error',
...
/**
  * Modifies Order by ID
  * @param {String} orderid
  * @param {String} operation - (APPROVE/CANCEL/REVOKE)
  * @param {Function} callback
  */
API.prototype.ModifyOrder = function(orderid, operation, callback) {
  var params = {
    'Request': {
      'OrderRequestHeader': {
        'AuthToken': this.auth,
  ...
  this.client.ModifyOrder(params, function(err, result, raw, soapHeader) {
    if (err) return callback({
      'status': '500',
      'output': {
        'result': 'error',
...
/**
  ...
  * @param {Object} opts
                      orderid    - String
                      csr        - String
                      dnsnames   - String (comma separated)
                      algorithm  - String (SHA1, SHA256)
                      extensions - Object
  * @param {Function} callback
  */
API.prototype.ReIssue = function(opts, callback) {
  var params = {
    'Request': {
      'OrderRequestHeader': {
        'AuthToken': this.auth,
      ...
      'TargetOrderID': opts.orderid,
      'HashAlgorithm': opts.algorithm,
      'Extensions': opts.extensions
    }
  };
  soap.createClient(this.host + 'GASService?wsdl', function(err, client) {
    if (err) return err;
    client.ReIssue(params, function(err, result, raw, soapHeader) {
      if (err) return callback({
        'status': '500',
        'output': {
          'result': 'error',
